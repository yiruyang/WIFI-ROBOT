...
public class NavController extends View {
    ...
    private final static int OUTER_COLOR_DEFAULT = Color.parseColor("#009f8e8e");
    ...
    public interface OnNavAndSpeedListener {
        void onNavAndSpeed(float nav, float speed, MotionEvent event);

        void onStop(float nav, float speed, MotionEvent event);
